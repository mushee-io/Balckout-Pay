...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      prove_income_threshold: (...args_1) => {
        ...
        const result_0 = this._prove_income_threshold_0(context,
                                                        partialProofData,
                                                        request_id_0,
                                                        required_income_0,
                                                        verifier_pk_0,
      ...
      register_verification_request: (...args_1) => {
        if (args_1.length !== 5) {
        ...
        const result_0 = this._register_verification_request_0(context,
                                                               partialProofData,
                                                               request_id_0,
                                                               required_income_0,
                                                               verifier_pk_0,
  ...
  _prove_income_threshold_0(context,
                            partialProofData,
                            request_id_0,
                            required_income_0,
                            verifier_pk_0,
  ...
  _register_verification_request_0(context,
                                   partialProofData,
                                   request_id_0,
                                   required_income_0,
                                   verifier_pk_0,
